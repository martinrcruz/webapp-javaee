                ...
                <div class="col-10">
                    <div class="container-fluid p-5 mt-5" style="background-color: rgba(219, 219, 219, 0.82); border-radius: 10px;">
                        <% String Vehiculo = (String) request.getAttribute("vehiculo");
                            String Combustible = (String) request.getAttribute("combustible");%>

                        <h2 class="text-center">Registro de ventas filtradas </h2>
                        <h4>Tipo de Vehiculo        : <%=Vehiculo%></h4>
                        <h4>Tipo de Combustible  : <%=Combustible%></h4>
                        <hr>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <%
                                                List<RegistroVentasMR> listTemp = (List<RegistroVentasMR>) request.getAttribute("listaFiltradaCV");
                                                for (int i = 0; i < listTemp.size(); i++) {
                                                    RegistroVentasMR temp = listTemp.get(i);
                                                    if (temp.getTipoVehiculo().equals(Vehiculo) && temp.getTipoCombustible().equals(Combustible)) {
                        ...
                        <div class="container-fluid">
                            <div class="row justify-content-center pt-5">
                                ...
                                <div class="col-md-2">
                                    <a class="btn btn-success pl-5 pr-5" href="CapturaDatos.jsp">Nueva Venta</a>
                                </div>
                                <div class="col-md-2">
                                    <a class="btn btn-secondary pl-5 pr-5" href="Reporte1.jsp">Listado de datos</a>
                                </div>
