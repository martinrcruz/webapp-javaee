...
<html>
    ...
    <body  style="background-image:url('Images/xK.gif'); background-repeat: repeat; background-size: 100%">
        ...
        <ul class="nav justify-content-center pt-3 pb-2" style="background-color: #4F5165;">
            ...
            <li class="nav-item">
                <a class="nav-link"  style="color: #FFFFFF" href="Reporte3a.jsp">REPORTE 3.1</a>
            </li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="container-fluid p-5 mt-5" style="background-color: rgba(219, 219, 219, 0.82); border-radius: 10px;">
                        <% String Vendedor = (String) request.getAttribute("nombreVendedor");
                               int dineroVendedor = (Integer) request.getAttribute("dineroVendedor");%>

                        <h2 class="text-center">Registro de ventas filtradas por Vendedor </h2>
                        <h4>Nombre vendedor        : <%= Vendedor%></h4>
                        <h4>Dinero recaudado        : <%=dineroVendedor%></h4>
                        <hr>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <%
                                                List<RegistroVentasMR> listTemp = (List<RegistroVentasMR>) request.getAttribute("filtroVendedor");
                                                for (int i = 0; i < listTemp.size(); i++) {
                                                    RegistroVentasMR temp = listTemp.get(i);
                                                    if (temp.getNombreVendedor().equals(Vendedor)) {
