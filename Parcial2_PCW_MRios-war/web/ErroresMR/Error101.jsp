            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="container-fluid p-5 mt-5" style="background-color: rgba(219, 219, 219, 0.82); border-radius: 10px;">
                        <div class="jumbotron">
                            <h1 class="display-4">Ups, Error 101 =(</h1>
                            <p class="lead">Campos vacios o datos nulos: Se ha enviado un formulario o solicitud sin llenar los campos requeridos.</p>
                            <hr class="my-4">
                            <p>Vuelve a intentarlo.</p>
                            <a class="btn btn-primary btn-lg" href="index.html" role="button">Volver a intentarlo</a>
                        </div>
