<%-- 
    ...
    Author     : martin
--%>
<%@page import="beansMR.ControladorVentasMRLocal"%>
<%@page import="beansMR.ControladorVentasMR"%>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="container-fluid p-5 mt-5" style="background-color: rgba(219, 219, 219, 0.82); border-radius: 10px;">
                        <h2 class="text-center">Registro realizado con exito!</h2>
                        <hr>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="alert alert-success btn-block text-center" role="alert">
                                    Se ha ingresado correctamente un  <a href="#" class="alert-link">REGISTRO DE VENTA </a> al Almacen de datos.
                                </div>
                                <div class="container">
                                    <div class="row">

                                        <%
                                            RegistroVentasMR temp = (RegistroVentasMR) request.getAttribute("ultimoRegistro");
                            ...
                            <div class="container-fluid">
                                <div class="row justify-content-center pt-5">
                                    ...
                                    <div class="col-md-2">
                                        <a class="btn btn-secondary pl-5 pr-5" href="index.html">Listado de datos</a>
                                    </div>
