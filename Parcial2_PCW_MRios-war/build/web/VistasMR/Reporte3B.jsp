...
<html>
    ...
    <body  style="background-image:url('Images/xK.gif'); background-repeat: repeat; background-size: 100%">
        ...
        <ul class="nav justify-content-center pt-3 pb-2" style="background-color: #4F5165;">
            ...
            <li class="nav-item">
                <a class="nav-link"  style="color: #FFFFFF" href="Reporte3b.jsp">REPORTE 3.2</a>
            </li>
        </ul>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <div class="container-fluid p-5 mt-5" style="background-color: rgba(219, 219, 219, 0.82); border-radius: 10px;">
                        <% String tipoCombustible = (String) request.getAttribute("tipoCombustible");
                            int cantidadCombustible = (Integer) request.getAttribute("cantidadCombustible");%>

                        <h2 class="text-center">Registro de litros vendidos por tipo de combustible </h2>
                        <h4>Tipo de combustible        : <%= tipoCombustible%></h4>
                        <h4>Cantidad de litros            : <%=cantidadCombustible%></h4>
                        <hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody
                                                ...
                                                <%
                                                    List<RegistroVentasMR> listTemp = (List<RegistroVentasMR>) request.getAttribute("filtradoCombustible");
                                                    for (int i = 0; i < listTemp.size(); i++) {
                                                        RegistroVentasMR temp = listTemp.get(i);
                                                        if (temp.getTipoCombustible().equals(tipoCombustible)) {
